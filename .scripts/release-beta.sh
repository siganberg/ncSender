...
# Get the latest stable v2+ tag (exclude pre-release tags: -beta, -internal, etc.)
LATEST_STABLE_TAG=$(git tag --sort=-version:refname | grep -E '^v[2-9]\.[0-9]+\.[0-9]+$' | head -1)
HAS_STABLE_TAG=true
