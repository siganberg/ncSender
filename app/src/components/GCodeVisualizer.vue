    ...
    <div ref="canvas" class="viewport__canvas">
      ...
      <div class="floating-toolbar floating-toolbar--top">
        ...
        <div class="file-controls">
          <input 
            ...
            style="display: none"
          />
          <button @click="$refs.fileInput.click()" class="load-button">
            Load G-code
          </button>
          <button v-if="hasFile" @click="clearFile" class="clear-button">
            Clear
          </button>
          <button v-if="hasFile" @click="toggleRapids" class="toggle-button">
            {{ showRapids ? 'Hide Rapids' : 'Show Rapids' }}
          </button>
        </div>
      </div>
      ...
      <div class="floating-toolbar floating-toolbar--bottom">
        <div class="legend-item">
          <span class="dot dot--rapid"></span>
          <span>Rapid (G0)</span>
        </div>
        <div class="legend-item">
          <span class="dot dot--feed"></span>
          <span>Feed (G1)</span>
        </div>
        <div class="legend-item">
          <span class="dot dot--arc"></span>
          <span>Arcs (G2/G3)</span>
        </div>
      </div>
    </div>
  </section>
