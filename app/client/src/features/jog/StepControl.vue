...
import {formatStepSize, formatJogFeedRate, formatStepSizeJogDisplay} from '@/lib/units';
...
const formatOptionStepDisplay = (value: number): string => {
  return formatStepSizeJogDisplay(value, false, appStore.unitsPreference.value);
};
