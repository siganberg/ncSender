 ...
 * @param units - The unit preference (metric or imperial)
 * @param axis - Optional axis name. Rotary axes (A, B, C) are always in degrees.
 */
export function formatCoordinate(value: number, units: UnitsPreference = 'metric', axis?: string): string {
