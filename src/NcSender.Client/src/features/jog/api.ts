...
export function jogStart(opts: { jogId: string; command: string; displayCommand?: string; axis: 'X'|'Y'|'Z'; direction: -1|1; feedRate: number; }) {
...
export function jogStep(opts: { command: string; displayCommand?: string; axis: 'X'|'Y'|'Z'; direction: -1|1; feedRate: number; distance: number; commandId?: string; }) {
