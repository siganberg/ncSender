...
const getHomeIconTexture = () => {
    ...
    // Explicit width/height alongside viewBox: Chrome rasterizes data-URL
    // SVGs that only have viewBox as 0×0 (no intrinsic size), so the home
    // texture came out blank. Safari/Firefox fell back to the viewBox
    // dimensions. Specifying width="512" height="512" makes Chrome render
