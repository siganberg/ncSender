...
public static class GrblAlarms
{
    private static readonly IReadOnlyDictionary<int, string> Alarms = new Dictionary<int, string>
    {
    ...
    public static string GetMessage(int code) =>
        Alarms.TryGetValue(code, out var message) ? message : "Unknown alarm";
}
